...
Check your transaction on Basescan: https://basescan.org/tx/${txHash}`);
      ...
      alert('Payment failed. Please try again or contact support@compute.io');
    }
  };
    ...
    <div className="pricing-container">
      ...
      <div className="pricing-grid">
        ...
        <div className={`pricing-card ${selectedTier === 'free' ? 'selected' : ''}`} 
          ...
          <a href="/dashboard" className="pricing-btn secondary">
            Get Started Free
          </a>
        ...
        <div className={`pricing-card ${selectedTier === 'enterprise' ? 'selected' : ''}`} 
          ...
          <a href="mailto:paigeblanch09@gmail.com" className="pricing-btn secondary">
            Contact Sales
          </a>
      ...
      <div className="manual-payment-section">
        ...
        <div className="payment-instructions">
          ...
          <ol>
            ...
            <li>Email the transaction hash to: <strong>paigeblanch09@gmail.com</strong></li>
      ...
      <div className="faq-section">
        ...
        <div className="faq-grid">
          <div className="faq-item">
            ...
            <p>We accept USDC on the Base network. Base offers fast transactions with low fees (~$0.01).</p>
          </div>

          <div className="faq-item">
            <h3>How do I get my API key?</h3>
            <p>After payment, email your transaction hash to paigeblanch09@gmail.com. We'll send your API key within 24 hours.</p>
          </div>

          <div className="faq-item">
            <h3>What happens after payment?</h3>
            <p>Once we verify your transaction on Base (usually instant), we'll generate your API key and email it to you.</p>
          </div>

          <div className="faq-item">
            <h3>Can I get a refund?</h3>
            <p>Due to the nature of blockchain transactions, all payments are final. However, unused credits never expire.</p>
          </div>
          ...
          <div className="faq-item">
            ...
            <p>Yes! Enterprise customers get custom pricing. Contact paigeblanch09@gmail.com for a quote.</p>
          </div>
        </div>
      </div>
